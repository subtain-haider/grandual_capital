                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group login-group__sub-title">
                                            ...
                                            {!! Form::text('app_name', $settings['app_name'] ?? '', ['class' => 'form-control login-group__input', 'required']) !!}
                                        </div>
                                    </div>
                                    <!-- Company Name Field -->
                                    <div class="col-md-6">
                                        <div class="form-group login-group__sub-title">
                                            ...
                                            {!! Form::text('company_name', $settings['company_name'] ?? '', ['class' => 'form-control login-group__input', 'required']) !!}
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group mt-2 d-flex flex-wrap">
                                            <div class="mt-2 user__upload-btn w-auto mr-sm-4 mr-2">
                                                <label class="btn btn-primary">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class=""><label class="login-group__sub-title">{{ __('messages.setting.pwa_icon').':' }}<span class="red">*</span></label><i class="fa fa-question-circle ml-1 fs-7" data-bs-toggle="tooltip" title="PWA icon must be 512x512"></i>
                                        </div>
                                        <div class="form-group mt-2 d-flex flex-wrap">
                                            <div class="mt-2 user__upload-btn w-auto mr-sm-4 mr-2">
                                                <label class="btn btn-primary">
                                            ...
                                            <div class="pwa-icon-wrapper mt-1" >
                                                <img src="{{ !empty($settings['pwa_icon']) ? url($settings['pwa_icon']) : asset('assets/images/logo.png') }}"
                                                     alt="" id="pwa-icon">
                                            </div>  
                                        </div>
                                    </div>
