        ...
        <div class="container">
            <div class="row">
                <div class="col-4 m-auto">
                    ...
                    @endif
                    <form method="POST" action="{{ route('password.email') }}" id="frmLogin" class="sky-form">
                        @csrf
                        <div class="mb-3">
...
{{--                            <label class="form-check-label float-right" > <a href="/password/reset"><u>Forgot Password</u></a></label>--}}
                        ...
                        <button type="submit" class="btn btn-primary m-auto">{{ __('Send Password Reset Link') }}</button>
                    </form>
                </div>
            </div>
        </div>
