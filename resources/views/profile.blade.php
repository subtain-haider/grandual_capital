            ...
            <div class="profile__inner m-auto">
                <div class="edit-profile-card w-100 mb-5 position-relative">
                    ...
                    <div class="text-center mb-4 edit-profile-card__btn">
                        ...
                        <label>
                             <button class="btn btn-danger mb-2 remove-profile-img" >{{__('messages.remove_profile')}}</button>
                        </label>
                        @endif
                    </div>
                </div>
                ...
                <div class="form-group bordered-input w-100">
                    <label for="about" class="mb-2 login-group__sub-title">{{ __('messages.bio').':' }}</label> <textarea
                ...
                <div class="form-group bordered-input w-100">
                    <div class="form-group pl-0 d-flex align-items-center">
                        {!! Form::checkbox('is_subscribed',1,$isSubscribed, ['id' => 'webNotification', 'class' => 'not-checkbox custom-checked mr-1']) !!}
                        &nbsp;<lable for="is_subscribed" class="mb-0">{{__('messages.enable_onesignal_web_application')}}</lable>
                    </div>
                </div>
                <div class="d-flex w-100">
                    {!! Form::button(__('messages.save') , ['type'=>'submit','class' => 'btn btn-primary mr-2 primary-btn','id'=>'btnEditSave','data-loading-text'=>"<span class='spinner-border spinner-border-sm'></span> " .__('messages.processing')]) !!}
