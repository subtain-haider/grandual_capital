...
<button title="Edit" class="index__btn btn btn-ghost-success btn-sm edit-btn mr-1" data-id="{{:id}}">
...
{{/if}}
{{if ~isArchive(deleted_at)}}
<button title="Restore" class="index__btn btn btn-ghost-success btn-sm restore-btn mr-1" data-id="{{:id}}">
