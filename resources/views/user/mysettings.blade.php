...
<div class="breadcrumb-container overflow-auto">
  <div class="btn-group btn-breadcrumb">
      ...
      <a class="btn btn-default">My</a>
      @if($subpage=="")
      <a href="{{ route('mysettings') }}" class="btn btn-default">Settings</a>
      @elseif($subpage=='account')
      <a href="{{ route('mysettings', ['account']) }}" class="btn btn-default">Account</a>
      @elseif($subpage=='shortcuts')
      <a href="{{ route('mysettings', ['shortcuts']) }}" class="btn btn-default">Shortcuts</a>
      @endif
  </div>
</div>
<!-- /Breadcrumb -->
      ...
      <div class="card p-3">
        <div class="e-navlist e-navlist--active-bg">
          <ul class="nav">
            ...
            <li class="nav-item"><a class="nav-link px-2" href="{{ route('user_profile', myid()) }}"><i class="fas fa-fw fa-user mr-1"></i><span>Profile</span></a></li>
            <li class="nav-item"><a class="nav-link px-2" href="{{ route('mysettings') }}"><i class="fa fa-fw fa-cog mr-1"></i><span>Settings</span></a></li>
            <li class="nav-item"><a class="nav-link px-2" href="{{ route('mysettings', ['shortcuts']) }}"><i class="fas fa-fw fa-tablet-alt mr-1"></i><span>Shortcuts</span></a></li>
            <li class="nav-item"><a class="nav-link px-2" href="{{ route('mysettings', ['account']) }}"><i class="fas fa-fw fa-unlock-alt mr-1"></i><span>Account</span></a></li>
                  ...
                  <div class="col-12 col-sm-auto mb-3">
                    <div class="mx-auto" style="width: 140px;">
                      <div class="d-flex justify-content-center align-items-center rounded" id="myavatar" style="height: 140px; background-color: rgb(233, 236, 239);">
                        <img src="{{ user_info(myid(), 'avatar') }}" alt="{{ user_info(myid(), 'name') }}" class="rounded-circle" width="150">
                      </div>
                    </div>
                  </div>
                  <div class="col d-flex flex-column flex-sm-row justify-content-between mb-3">
                    <div class="text-center text-sm-left mb-2 mb-sm-0">
                      <h4 class="pt-sm-2 pb-1 mb-0 text-nowrap">{{ user_info(myid(), 'name') }}</h4>
                   
                      @if(!empty(user_info(myid(), 'profession'))) <p class="mb-0">{{ user_info(myid(), 'profession') }}</p>@endif
                      @if(!empty(user_info(myid(), 'location'))) <div class="text-muted"><small>{{ user_info(myid(), 'location') }}</small></div>@endif
                    ...
                    <div class="text-center text-sm-right">
                      <span class="badge badge-secondary">{{ level(myid()) }}</span>
                      <div class="text-muted"><small>{{ humman_date(user_info(myid(), 'created_at')) }}</small></div>
                    </div>
                  </div>
                </div>
                <ul class="nav nav-tabs">
                  @if($subpage=='')
                  <li class="nav-item"><a href="{{ route('mysettings') }}" class="active nav-link">Settings</a></li>
                  <li class="nav-item"><a href="{{ route('mysettings', ['account']) }}" class="nav-link">Account</a></li>
                  <li class="nav-item"><a href="{{ route('mysettings', ['shortcuts']) }}" class="nav-link">Shortcuts</a></li>
                  @elseif($subpage=='account')
                  <li class="nav-item"><a href="{{ route('mysettings') }}" class="nav-link">Settings</a></li>
                  <li class="nav-item"><a href="{{ route('mysettings', ['account']) }}" class="active nav-link">Account</a></li>
                  <li class="nav-item"><a href="{{ route('mysettings', ['shortcuts']) }}" class="nav-link">Shortcuts</a></li>
                
                  @elseif($subpage=='shortcuts')
                  <li class="nav-item"><a href="{{ route('mysettings') }}" class="nav-link">Settings</a></li>
                  <li class="nav-item"><a href="{{ route('mysettings', ['account']) }}" class="nav-link">Account</a></li>
                  <li class="nav-item"><a href="{{ route('mysettings', ['shortcuts']) }}" class="active nav-link">Shortcuts</a></li>
                  @endif
                </ul>
                  ...
                  <div class="tab-pane active">
                        ...
                        <div class="col">
                          <div class="row">
                            <div class="col">
                              <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="name" placeholder="Name Surname..." value="{{ user_info(myid(), 'full_name') }}">
                              </div>
                            </div>
                            <div class="col">
                              <div class="form-group">
                                <label>Username</label>
                                <input class="form-control" type="text" name="username" placeholder="{{ user_info(myid(), 'name') }}" value="{{ user_info(myid(), 'name') }}">
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col">
                              <div class="form-group">
                                <label>Address</label>
                                <input class="form-control" type="text" name="address" value="{{ user_info(myid(), 'location') }}" placeholder="California, LA...">
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col">
                              <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="profeesion" value="{{ user_info(myid(), 'profession') }}" placeholder="Your proffession here...">
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col mb-3">
                              <div class="form-group">
                                ...
                                <textarea class="form-control" rows="5" name="social_msg" placeholder="Write something what would you say to people...">{{ user_info(myid(), 'social_msg') }}</textarea>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="row">
                        <div class="col">
                          <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="email" placeholder="{{ user_info(myid(), 'name') }}" value="{{ user_info(myid(), 'email') }}">
                            @error('email')
                    ...
                    @if($subpage=='shortcuts')
                      ...
                      <div style="display:none !important;">
                        <textarea name="keepenCode" id="keepenCode">{{ my('shortcuts') }}</textarea>
