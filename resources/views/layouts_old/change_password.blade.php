        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group col-sm-12">
                    ...
                    {!! Form::password('password', ['class' => 'form-control login-group__input', 'required']) !!}
                </div>
                <div class="form-group col-sm-12 mb-4">
                    {!! Form::label('password_confirmation', __('messages.confirm_password').':', ['class' => 'login-group__sub-title']) !!}<span
                            class="red">*</span>
                    {!! Form::password('password_confirmation', ['class' => 'form-control login-group__input', 'required']) !!}
                </div>
                <div class="text-left form-group col-sm-12 mb-2">
