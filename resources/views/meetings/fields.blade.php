<div class="form-group col-sm-6 login-group__sub-title">
    ...
    {!! Form::text('topic', isset($meeting) ? $meeting->topic : null, ['class' => 'form-control login-group__input', 'required']) !!}
</div>
...
<div class="form-group col-sm-3 col-md-6 col-lg-6 col-xl-3 login-group__sub-title">
    ...
    {!! Form::text('start_time', isset($meeting) ? $meeting->start_time : null, ['class' => 'form-control start-time login-group__input', 'required', 'autocomplete' => 'off']) !!}
</div>
...
<div class="form-group col-sm-6 col-md-6 col-lg-6 col-xl-3">
    ...
    {!! Form::select('time_zone', $timeZones, isset($meetingTimeZone) ? $meetingTimeZone : null, ['class' => 'form-control time-zone', 'placeholder' => 'Select timezone', 'required' ]) !!}
</div>
...
<div class="form-group col-sm-6 col-md-6 col-lg-6 col-xl-3 login-group__sub-title">
    ...
    {!! Form::text('duration', isset($meeting) ? $meeting->duration : null, ['class' => 'form-control login-group__input', 'required', 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")']) !!}
</div>
...
<div class="form-group col-sm-6 col-lg-6 col-xl-3">
    ...
    <div class="d-flex login-group__input align-items-center">
        <div class="custom-control custom-radio mx-2">
            <input type="radio" id="host-enabled" class="custom-control-input" name="host_video" value="1" {{ isset($meeting) ? ($meeting->host_video == 1 ? 'checked' : '') : null }} required>
            <label class="custom-control-label" for="host-enabled"> {{__('messages.meeting.enabled')}}&nbsp; </label>
        </div>
        <div class="custom-control custom-radio mx-2">
            <input type="radio" id="host-disabled" class="custom-control-input" name="host_video" {{ isset($meeting) ? ($meeting->host_video == 0 ? 'checked' : '') : null }} value="0" required>
...
<div class="form-group col-sm-6 col-lg-6 col-xl-3">
    ...
    <div class="d-flex login-group__input align-items-center">
        <div class="custom-control custom-radio mx-2">
            <input type="radio" id="enabled" class="custom-control-input" name="participant_video"  {{ isset($meeting) ? ($meeting->participant_video == 1 ? 'checked' : '') : null }} value="1" required>
            <label class="custom-control-label" for="enabled"> {{__('messages.meeting.enabled')}}&nbsp; </label>
        </div>
        <div class="custom-control custom-radio mx-2">
            <input type="radio" id="disabled" class="custom-control-input" {{ isset($meeting) ? ($meeting->participant_video == 0 ? 'checked' : '') : null }} name="participant_video" value="0" required>
...
<div class="form-group col-sm-12 login-group__sub-title">
    ...
    {{ Form::textarea('agenda', null, ['class' => 'form-control login-group__input', 'required']) }}
</div>

<div class="form-group col-sm-12 mb-0">
    {{ Form::button(__('messages.save') , ['type'=>'submit','class' => 'btn btn-primary mr-1','id'=>'btnSave','data-loading-text'=>"<span class='spinner-border spinner-border-sm'></span> " .__('messages.processing')]) }}
