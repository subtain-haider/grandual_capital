...
--
-- Host: localhost:3306
-- Generation Time: Aug 24, 2021 at 12:21 PM
...
INSERT INTO `permissions` (`id`, `name`, `guard_name`, `display_name`, `created_at`, `updated_at`) VALUES
                                                                                                       (1, 'manage_users', 'web', 'Manage Users', '2021-08-24 06:51:27', '2021-08-24 06:51:27'),
                                                                                                       (2, 'manage_roles', 'web', 'Manage Roles', '2021-08-24 06:51:27', '2021-08-24 06:51:27'),
                                                                                                       (3, 'manage_reported_users', 'web', 'Manage Reported Users', '2021-08-24 06:51:27', '2021-08-24 06:51:27'),
                                                                                                       (4, 'manage_conversations', 'web', 'Manage Conversations', '2021-08-24 06:51:27', '2021-08-24 06:51:27'),
                                                                                                       (5, 'manage_settings', 'web', 'Manage Settings', '2021-08-24 06:51:27', '2021-08-24 06:51:27'),
                                                                                                       (6, 'manage_meetings', 'web', 'Manage Meetings', '2021-08-24 06:51:27', '2021-08-24 06:51:27');
...
INSERT INTO `roles` (`id`, `name`, `guard_name`, `is_default`, `created_at`, `updated_at`) VALUES
                                                                                               (1, 'Admin', 'web', 1, '2021-08-24 06:51:27', '2021-08-24 06:51:27'),
                                                                                               (2, 'Member', 'web', 1, '2021-08-24 06:51:27', '2021-08-24 06:51:27');
...
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `phone`, `last_seen`, `is_online`, `is_active`, `about`, `photo_url`, `activation_code`, `remember_token`, `created_at`, `updated_at`, `is_system`, `player_id`, `is_subscribed`, `privacy`, `gender`, `deleted_at`, `language`) VALUES
    (1, 'Super Admin', 'admin@gmail.com', '2021-08-24 06:51:27', '$2y$10$O9oK0Som9YSOcENPV5VS3uEBlm6kRf7pK7UUruFTdEwbnO0Npp7vC', NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, '2021-08-24 06:51:27', '2021-08-24 06:51:27', 1, NULL, NULL, 1, NULL, NULL, 'en');
