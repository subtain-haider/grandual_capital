            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-sm-12 d-flex flex-sm-row flex-column align-items-center">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6 login-group__sub-title">
                                ...
                                {!! Form::text('name', null, ['class' => 'form-control login-group__input', 'id' => 'edit_name', 'required']) !!}
                            </div>

                            <!-- Phone Field -->
                            <div class="form-group col-lg-6 login-group__sub-title">
                                {!! Form::label('phone', __('messages.phone').':' ) !!}
                                {!! Form::text('phone', null, ['class' => 'form-control login-group__input', 'id' => 'edit_phone']) !!}
                            </div>

                            <!-- Email Field -->
                            <div class="form-group col-12 login-group__sub-title">
                                {!! Form::label('email', __('messages.email').':' ) !!}<span class="red">*</span>
                                {!! Form::email('email', null, ['class' => 'form-control login-group__input', 'id' => 'edit_email',  'required']) !!}
                            </div>
                        </div>
                    </div>
                    <!-- Bio Field -->
                    <div class="form-group login-group__sub-title col-12">
                        ...
                        {!! Form::textarea('about', null, ['class' => 'form-control user__bio login-group__input', 'rows' => 3, 'id' => 'edit_about']) !!}
                    </div>
                    <div class="col-sm-12">
                        <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6 login-group__sub-title">
                                ...
                                {!! Form::select('is_active', [1 => 'Active', 0 => 'In Active'], (isset($user->is_active)) ? $user->is_active : [],  ['class' => 'form-control login-group__input', 'id' => 'edit_is_active',  'required']) !!}
                            </div>
                            <!-- Role Field -->
                            <div class="form-group col-sm-6 login-group__sub-title">
                                {!! Form::label('role', __('messages.role').':' ) !!}<span class="red">*</span>
                                {!! Form::select('role_id', $roles, (isset($user->role_id)) ? $user->role_id : [],  ['class' => 'form-control login-group__input','placeholder' => 'Select Role', 'id' => 'edit_role_id']) !!}
                            </div>
                        </div>
                    </div>
                    <!-- Submit Field -->
                    <div class="text-left form-group mb-0 col-sm-12">
