            ...
            <div class="chat__inner">
                ...
                <div class="chat__people-wrapper chat__people-wrapper--responsive">
                    <div class="chat__people-wrapper-header">
                        ...
                        <div class="d-flex chat__people-wrapper-btn-group ml-1">
                            <i class="nav-icon fa fa-bars align-top chat__people-wrapper-bar"></i>

                            @if($enableGroupSetting == 1)
                                @if(Auth::user()->hasRole('Admin'))
                                    <div class="chat__people-wrapper-button btn-create-group mr-2 d-flex align-items-center" data-toggle="modal"
                                         data-target="#createNewGroup">
                                        <i class="nav-icon group-icon color-green remove-tooltip" data-toggle="tooltip"
                            ...
                            @endif
                            @if(Auth::user()->hasRole('Admin'))
                            <div class="chat__people-wrapper-button d-flex align-items-center" data-toggle="modal"
                                 data-target="#addNewChat">
                                <i class="nav-icon remove-tooltip" data-toggle="tooltip" data-placement="bottom"
                                   title="{{ __('messages.new_conversation') }}"><img
                                            src="{{asset('assets/icons/bubble-chat.png')}}" width="30" height="30"></i>
                            </div>
                            @endif
                            <i class="nav-icon fa fa-times align-top chat__people-close-bar d-sm-none d-block align-self-center ml-2"></i>
                        </div>
                    </div>
                    ...
                    <ul class="nav nav-tabs chat__tab-nav mb-1 border-bottom-0" id="chatTabs">
                        <li class="nav-item">
                            <a data-toggle="tab" id="activeChatTab" class="nav-link active login-group__sub-title" href="#chatPeopleBody">{{__('messages.chats.active_chat')}}</a>
                        </li>
                        <li class="nav-item">
                            <a data-toggle="tab" id="archiveChatTab" class="nav-link login-group__sub-title" href="#archivePeopleBody">{{__('messages.chats.archive_chat')}}</a>
                        </li>
                    </ul>
                ...
                <div class="chat__area-wrapper ml-lg-3">
                ...
                <div class="modal-content modal-new-conversation">
                    ...
                    <div class="modal-body">
                        <nav class="nav nav-pills flex-wrap" id="myTab" role="tablist">
                            ...
                            <a class="nav-item nav-link wrap-text" id="nav-users-tab" data-toggle="tab"
                            ...
                            @endif
                                <a class="nav-item nav-link" id="nav-blocked-users-tab" data-toggle="tab"
