                    ...
                    <li class="mb-0 list-group-item group-members-list-chat-select__list-item align-items-center d-flex justify-content-between">
                        <div class="d-flex w-100 align-items-center">
                            ...
                            <div class="truncate-button">
                                <div class="add-user-contact-name align-self-center text-truncate">{{ $contact['name'] }}</div>
                                <div class="align-self-center add-user-email text-truncate">{{ $contact['email'] }}</div>
                            </div>
                            <span class="btn btn-sm btn-success float-right add-group-member ml-auto" data-id="{{ $contact['id'] }}">Add</span>
                        </div>
                    </li>
                @endforeach
