                  ...
                  <li class="dropdown user-dropdown">
                      <a href="#" class="dropdown-toggle mr-n1" data-toggle="dropdown">
                          <div class="user-toggle">
                              <div class="user-avatar sm">
                                    <img src="{{Auth::user()->image != null?asset('storage/users/'.Auth::user()->image):asset('assets/admin/img/default-avatar.png')}}" alt="{{Auth::user()->image}}">
                      ...
                      <div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
                          ...
                          <div class="dropdown-inner">
                              <ul class="link-list">
                                  <li><a href="{{url('user/profile')}}"><em class="icon ni ni-user-alt"></em><span>View Profile</span></a></li>
