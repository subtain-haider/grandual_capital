...
@section('title', 'Edit topic - '.topic_info($topicid, 'title'))
@section('content')
...
<link rel="stylesheet" href="{{ asset('assets/css/elements/accordion.css') }}">
    ...
    <div class="breadcrumb-container overflow-auto">
        <div class="btn-group btn-breadcrumb">
            ...
            <a class="btn btn-default">Edit topic</a>
        </div>
    </div>

<div clsass="topic-container"><h2 class="h2_topic">{{ topic_info($topicid, 'title') }}</h2></div>
<div class="all_post_items_container bg-white">
    <div class="card-header bg-white text-uppercase bold">
        Edit topic<span class="material-icons pull-right">timeline</span>
    </div>

    @php
        $title = old('title') ?: topic_info($topicid, 'title');
        $text = old('content') ?: Post_info($postid, 'text');
        $question = old('question') ?: PollQuestion($pollid, 'question');

        $q_one = old('q_one') ?: PollQuestion($pollid, 'ans_1');
        $q_two = old('q_two') ?: PollQuestion($pollid, 'ans_2');
        $q_three = old('q_three') ?: PollQuestion($pollid, 'ans_3');
        $q_four = old('q_four') ?: PollQuestion($pollid, 'ans_4');
        $q_five = old('q_five') ?: PollQuestion($pollid, 'ans_5');
        $q_six = old('q_six') ?: PollQuestion($pollid, 'ans_6');
        $q_seven = old('q_seven') ?: PollQuestion($pollid, 'ans_7');

        $start_date = (old('start_date') ?: PollQuestion($pollid, 'starts')) ?: dayXnow();
        $poll_ends = (old('end_date') ?: PollQuestion($pollid, 'ends')) ?: nextXday(10);
        $disabled_status = (old('offstatus') ?: PollQuestion($pollid, 'disabled')) ?: 0;

    @endphp

    <div class="card py-2 mb-4 border-0">
        <div class="card-body">
            <form action="{{ route('EditTopic', array('id'=>$topicid)) }}" method="post">
                {{ csrf_field() }}
              
                <div class="form-group">
                    <label for="input_title" class="input__label">Topic title</label>
                    <input type="text" name="title" class="form-control input-style {{ $errors->has('title') ? 'error' : '' }}" id="input_title" value="{{ $title }}" placeholder="Enter topic title here...">
                    @error('title')
                        ...
                        <div id="collapse4" class="panel-collapse collapse" aria-expanded="false" style="">
                            <div class="acdn-body">
                                ...
                                <div class="alert alert-info" role="alert">
                                    <strong>Heads up!</strong> To add a poll you need to ask a question and fill in at least two possible answers (otherwise the poll will not appear in the topic). In case of non-indication of the start and end date of the survey or incorrectly, the start date of the survey is defined as the current day, and the end date is the next tenth day.
                                </div>

                                <div class="form-group">
                                    <input type="text" name="question" class="form-control input-style" value="{{ $question }}" placeholder="What`s your question?">
                                    @error('question')
                                        <span class="invalid-feedback" style="display:block !important;" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="q_one" value="{{ $q_one }}" class="form-control input-style" id="inputAddress2" placeholder="Answer...">
                                        @error('q_one')
                                            <span class="invalid-feedback" style="display:block !important;" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="validationTooltipUsernamePrepend">2</span>
                                        </div>
                                        <input type="text" name="q_two" value="{{ $q_two }}" class="form-control input-style" id="inputAddress2" placeholder="Answer...">
                                        @error('q_two')
                                            <span class="invalid-feedback" style="display:block !important;" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="validationTooltipUsernamePrepend">3</span>
                                        </div>
                                        <input type="text" name="q_three" value="{{ $q_three }}" class="form-control input-style" id="inputAddress2" placeholder="Answer...">
                                        @error('q_three')
                                            <span class="invalid-feedback" style="display:block !important;" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="validationTooltipUsernamePrepend">4</span>
                                        </div>
                                        <input type="text" name="q_four" value="{{ $q_four }}" class="form-control input-style" id="inputAddress2" placeholder="Answer...">
                                        @error('q_four')
                                            <span class="invalid-feedback" style="display:block !important;" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="validationTooltipUsernamePrepend">5</span>
                                        </div>
                                        <input type="text" name="q_five" value="{{ $q_five }}" class="form-control input-style" id="inputAddress2" placeholder="Answer...">
                                        @error('q_five')
                                            <span class="invalid-feedback" style="display:block !important;" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="validationTooltipUsernamePrepend">6</span>
                                        </div>
                                        <input type="text" name="q_six" value="{{ $q_six }}" class="form-control input-style" id="inputAddress2" placeholder="Answer...">
                                        @error('q_six')
                                            <span class="invalid-feedback" style="display:block !important;" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="validationTooltipUsernamePrepend">7</span>
                                        </div>
                                        <input type="text" name="q_seven" value="{{ $q_seven }}" class="form-control input-style" id="inputAddress2" placeholder="Answer...">
                                        @error('q_seven')
                                            <span class="invalid-feedback" style="display:block !important;" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="datepicker-dropdown">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="start_date" class="form-control input-style" value="{{ $start_date }}" id="pollstart_date" placeholder="Poll starts today?" readonly>
                                            </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="datepicker-dropdown">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="end_date" class="form-control input-style" value="{{ $poll_ends }}" id="pollends_date" placeholder="When it ends?" readonly>
                                            </div>
                                            <div class="datepicker-dropdown-content">
                                ...
                                <div class="form-check check-remember check-me-out">
                                    ...
                                    @endif
                                    <input type="hidden" name="offstatus" value="{{ $disabled_status }}" id="putcheck">
                ...
                <div class="form-group">
                    <!--start tags-->
                    <div id="tags_to_save" style="display:block !important;">{!! old('answerskeeper') !!}</div>
                    ...
                    <textarea name="content" id="summernote" style="display: none !important;">{{ $text }}</textarea>
