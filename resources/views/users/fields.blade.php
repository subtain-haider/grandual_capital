<div class="row">
    ...
    <div class="col-sm-12 d-flex flex-sm-row flex-column align-items-center">
        ...
        <div class="row">
            ...
            <div class="form-group col-lg-6 login-group__sub-title">
                ...
                {!! Form::text('name', null, ['class' => 'form-control login-group__input', 'id' => 'name', 'required']) !!}
            </div>
            <!-- Phone Field -->
            <div class="form-group col-lg-6 login-group__sub-title">
                {!! Form::label('phone', __('messages.phone').':' ) !!}
                {!! Form::text('phone', null, ['class' => 'form-control login-group__input', 'id' => 'phone']) !!}
            </div>
            <!-- Email Field -->
            <div class="form-group col-12 login-group__sub-title">
                {!! Form::label('email', __('messages.email').':' ) !!}<span class="red">*</span>
                {!! Form::email('email', null, ['class' => 'form-control login-group__input', 'id' => 'email', 'required']) !!}
            </div>
        </div>
    </div>
    <div class="col-sm-12">
        ...
        <div class="form-group login-group__sub-title">
            ...
            {!! Form::textarea('about', null, ['class' => 'form-control user__bio login-group__input', 'rows' => 3, 'id' => 'about']) !!}
        </div>
        <div class="row">
            ...
            <div class="form-group col-sm-6">
                ...
                <div class="d-flex login-group__input align-items-center">
                    ...
                    <div class="custom-control custom-radio mx-2">
                        <input type="radio" class="custom-control-input" id="privacyPublic" name="privacy" value="1" required> <label
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-6 login-group__sub-title">
                ...
                {!! Form::select('is_active', [1 => 'Active', 0 => 'In Active'], (isset($user->is_active)) ? $user->is_active : [],  ['class' => 'form-control login-group__input', 'id' => 'is_active',  'required']) !!}
            </div>
            <!-- Role Field -->
            <div class="form-group col-sm-6 login-group__sub-title">
                {!! Form::label('role', __('messages.role').':' ) !!}<span class="red">*</span>
                {!! Form::select('role_id', $roles, (isset($user->role_id)) ? $user->role_id : [],  ['class' => 'form-control login-group__input','placeholder' => 'Select Role', 'id' => 'role_id', 'required']) !!}
            </div>
        </div>
        <div class="row">
            <div class="form-group col-sm-6 login-group__sub-title">
                ...
                <input type="password" name="password" class="form-control login-group__input" onkeypress="return avoidSpace(event)"
                       required>
            </div>
            <div class="form-group col-sm-6 login-group__sub-title">
                <div class="">
    ...
    <!-- Submit Field -->
    <div class="text-left form-group col-sm-12">
