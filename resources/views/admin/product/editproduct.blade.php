                                ...
                                <div class="card card-full">
                                    <div class="nk-ecwg nk-ecwg8 h-100">
                                        <div class="card-inner ml-1 mr-1 my-1">
                                               <form class="form-validate is-alter" action="{{route('products.update',$product->id)}}"  method="POST" enctype="multipart/form-data" >
                                                    @csrf
                                                   @method('PUT')
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" name="name"  aria-required aria-invalid="false" class="form-control" value="{{ $product->name }}" required="true" aria-required="true"
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" name="key" required value="GrandeurCapital" class="form-control"  value="{{ $product->key }}"  required> 
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input  type="text" name="video" class="form-control"   value="{{$product->video}}"  required> 
                                                        </div>
                                                    </div>
                                                                ...
                                                                <select class="form-control"  data-style="btn btn-rose btn-round" title="Select Category" name="category_id"  id="default-07">
                                                                    @foreach ($categorys as $category)
                                                                        ...
                                                                        <option value="{{ $category->id }}"
                                                                            {{ $product->p_category_id == $category->id ? 'selected' : '' }}>
                                                                    ...
                                                                    <a href="#pablo" class="btn btn-danger btn-round fileinput-exists"
                                                                        data-dismiss="fileinput"><i class="fa fa-times"></i> Remove<div
                                                                            ...
                                                                            <div class="ripple-decorator ripple-on ripple-out"
                                                                                style="left: 55.4062px; top: 24px; background-color: rgb(255, 255, 255); transform: scale(15.5098);">
                                                                            </div>
                                                                        </div></a>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" name="one_description" class="form-control"  value="{{ $product->one_description }}"  >
                                                        </div>
                                                    </div>
