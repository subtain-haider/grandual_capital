    ...
    function DateTimePicker(element, options) {
        var picker = {},
            ...
            _createDatePicker = function () {
                ...
                $table.$prevm = _createCell($row, '<i class="las la-angle-left"></i>', 1, NAV['prevm'], "prevm");
                //head - tools - title
                $table.$title = $('<td class="title" colspan="5"/>').data('nav', NAV['title']).appendTo($row);
                //head - tools - prev month
                $table.$nextm = _createCell($row, '<i class="las la-angle-right"></i>', 1, NAV['nextm'], "nextm");
                $row.appendTo($thead);
                //head - week names
                $row = $('<tr/>');
                var i;
            ...
            _createTimePicker = function (viewmode) {
                ...
                $table.focus = $table.$m;
                var $add = $('<td/>').append($('<i class="las la-angle-up"></i>')).data('nav', NAV['plus']);
                var $min = $('<td/>').append($('<i class="las la-angle-down"></i>')).data('nav', NAV['minus']);
